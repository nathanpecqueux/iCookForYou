...
-- Généré le :  Mar 13 Février 2018 à 08:41
...
--
CREATE DATABASE IF NOT EXISTS `icookforyou` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `icookforyou`;
...
--
-- Création :  Mer 07 Février 2018 à 14:28
--
...
--
-- RELATIONS POUR LA TABLE `TAllergy`:
--
...
--
-- RELATIONS POUR LA TABLE `TCategory`:
--   `idParentCategory`
--       `TCategory` -> `idCategory`
--
...
--
-- Création :  Mer 07 Février 2018 à 14:29
--
...
--
-- RELATIONS POUR LA TABLE `TFavorites`:
--   `idRecipeF`
--       `TRecipe` -> `idRecipe`
--   `idUserF`
--       `TUser` -> `idUser`
...
--
-- Création :  Mer 07 Février 2018 à 14:35
--
...
--
-- RELATIONS POUR LA TABLE `THistory`:
--   `idRecipeH`
--       `TRecipe` -> `idRecipe`
--   `idUserH`
--       `TUser` -> `idUser`
...
--
-- RELATIONS POUR LA TABLE `TRecipe`:
--   `idProviderR`
--       `TRecipeProvider` -> `idRecipeProvider`
--
...
--
-- RELATIONS POUR LA TABLE `TRecipeProvider`:
--
...
--
-- RELATIONS POUR LA TABLE `TUserAllergy`:
--   `idAllergyUA`
--       `TAllergy` -> `idAllergy`
--   `idUserUA`
--       `TUser` -> `idUser`
...
--
-- RELATIONS POUR LA TABLE `TUserDiet`:
--   `idDietUD`
--       `TDiet` -> `idDiet`
--   `idUserUD`
--       `TUser` -> `idUser`
...
--
-- RELATIONS POUR LA TABLE `TUserTool`:
--   `idToolUT`
--       `TTool` -> `idTool`
--   `idUserUT`
--       `TUser` -> `idUser`
